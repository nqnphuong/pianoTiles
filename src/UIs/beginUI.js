...
export class BeginUI extends Container {
    constructor(fullNameMusic) {
        super();
        this.fullNameMusic = fullNameMusic;
        this.create();
    }
    ...
    createMusicTitle() { // biến này là nhập tên bài hát - tên bài hát được chọn từ ban đầu
        ...
        this.musicTitle = new Text(this.fullNameMusic, style);
